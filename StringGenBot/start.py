...
بواسطـة : [ٌٍSAKRAN ⚡️](tg://user?id=6950300507) !""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("⚙ الــســــوࢪسـ ⚙️", url="https://t.me/SOURCESAKRAN"),
                    InlineKeyboardButton("SAKRAN ⚡️", user_id=6950300507)
                ]
            ]
        ),
